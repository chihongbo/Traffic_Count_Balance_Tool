...
#orridorList=[['I285EB',35545,281008,80053,FTMain,FTRamp],['I285W',80056,257926,35544,FTMain,FTRamp]]
#corridorList=[['I4SB',118118,110757,9020]]

#corridorList=[['I85NB1',89186,208943,102704,FTMain,FTRamp],['I85NB2',102704,297706,116127,FTMain,FTRamp],['I85NB3',116127,10252,123456,FTMain,FTRamp]]
...
f=open('BreadthFirstCorridor_I85SB.csv','w+')
